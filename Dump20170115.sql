...
REPLACE INTO `bitacora_cuotas` VALUES (1,'12','2014',1,'2015-01-01','joanesbe'),(2,'12','2014',2,'2015-01-01','joanesbe'),(3,'12','2014',3,'2015-01-01','joanesbe'),(53,'01','2015',1,'2017-01-15','joanesbe'),(54,'01','2015',2,'2017-01-15','joanesbe'),(55,'01','2015',3,'2017-01-15','joanesbe'),(56,'02','2015',2,'2017-01-15','joanesbe'),(57,'02','2015',3,'2017-01-15','joanesbe');
...
REPLACE INTO `cat_colonos` VALUES (1,'ADRIAN  VALDES  HERNANDEZ','','4271482522','joanesbe@gmail.com',NULL,NULL,'A','2016-10-20'),(2,'BEATRIZ  MASSO  ROSALES','','','joanesbe@gmail.com',NULL,NULL,'A','2016-10-20'),(3,'CASA CLUB','','','joanesbe@gmail.com',NULL,NULL,'A','2016-10-20');
...
REPLACE INTO `cat_lotes` VALUES (1,'1',1,1,2500,'A','2016-10-03'),(2,'1',2,2,5000,'A','2016-10-20'),(3,'1',3,3,2500,'A','2016-10-03'),(4,'2',3,3,4500,'A','2016-10-03');
...
REPLACE INTO `cat_manzanas` VALUES (1,'I','A','2016-10-03'),(2,'II','A','2016-10-20'),(3,'III','A','2016-10-03');
...
REPLACE INTO `cat_medidores` VALUES (1,1,'01-01','123a',81,'A','2016-10-03'),(2,2,'02-01','123b',126,'A','2016-10-20'),(3,3,'03-01','123',81,'A','2016-10-03'),(4,4,'03-01A','123A',117,'A','2016-10-03'),(5,4,'03-02B','123C',117,'A','2016-10-03');
...
REPLACE INTO `cat_perfiles` VALUES (1,'Administrador','A','2016-10-01'),(2,'Cajero','A','2016-10-20');
...
REPLACE INTO `cat_periodos` VALUES (1,'01','Enero','I','2016-09-01'),(2,'02','Febrero','A','2016-09-01'),(3,'03','Marzo','I','2016-09-01'),(4,'04','Abril','I','2016-09-01'),(5,'05','Mayo','I','2016-09-01'),(6,'06','Junio','I','2016-09-01'),(7,'07','Julio','I','2016-09-01'),(8,'08','Agosto','I','2016-09-01'),(9,'09','Septiembre','I','2016-09-01'),(10,'10','Octubre','I','2016-09-01'),(11,'11','Noviembre','I','2016-09-01'),(12,'12','Diciembre','I','2016-09-01');
...
REPLACE INTO `cat_puestos` VALUES (1,'Administrador','A','2010-10-01'),(2,'Contador','A','2016-10-20');
...
REPLACE INTO `cat_usuarios` VALUES (1,'Jose Antonio Estrada','Gregorio Moreno','1','joanesbe','123','1','A','2016-01-01'),(2,'Yolanda','Hacienda Grande','2','usuario','contraseña','2','A','2016-10-20');
...
REPLACE INTO `detalle_accesos` VALUES (1,'1','1'),(2,'1','2'),(3,'1','3'),(4,'1','4'),(5,'1','5'),(6,'1','6'),(7,'1','7'),(8,'1','8'),(9,'1','9'),(10,'1','10'),(15,'1','11'),(16,'1','12'),(24,'3','9'),(25,'1','14'),(26,'1','15'),(27,'3','5'),(28,'3','8'),(30,'3','1'),(31,'4','11'),(32,'2','2'),(33,'2','11'),(34,'2','12'),(35,'2','13');
...
REPLACE INTO `detalle_anticipos` VALUES (1,1,3,1000,1000,'','1',0,'','1',0,'A','2017-01-15',NULL),(2,1,3,1000,1000,'','1',0,'','1',0,'A','2017-01-15',NULL),(3,2,3,1000,1000,'','1',0,'','1',0,'A','2017-01-15',NULL);
...
REPLACE INTO `gestion_cuotas_agua` VALUES (1,5,1,'AN',418.4,3),(2,6,3,'AN',523,3),(3,7,5,'PA',2210.5,1),(4,8,6,'PA',3188,1),(5,9,7,'PA',973,1),(6,14,1,'AN',973,3),(7,15,3,'AN',104.6,3);
...
REPLACE INTO `kardex_servicios` VALUES (1,'C00-MA',1,1,2,750,NULL,'Cuota Mantenimiento','01','2015','S',NULL,1,2,'2017-01-15'),(2,'C00-MA',2,2,2,1500,NULL,'Cuota Mantenimiento','01','2015','S',NULL,1,2,'2017-01-15'),(3,'C00-MA',3,3,2,750,NULL,'Cuota Mantenimiento','01','2015','S',NULL,1,2,'2017-01-15'),(4,'C00-MA',4,4,2,1350,NULL,'Cuota Mantenimiento','01','2015','S',NULL,1,2,'2017-01-15'),(5,'C00-AG',0,1,3,418.4,418.4,'Cuota Agua','01','2015','S',NULL,NULL,0,'2017-01-15'),(6,'C00-AG',0,2,3,523,523,'Cuota Agua','01','2015','S',NULL,NULL,0,'2017-01-15'),(7,'C00-AG',5,3,3,2210.5,0,'Cuota Agua','01','2015','S',NULL,1,0,'2017-01-15'),(8,'C00-AG',6,4,3,3188,0,'Cuota Agua','01','2015','S',NULL,1,0,'2017-01-15'),(9,'C00-AG',7,5,3,973,0,'Cuota Agua','01','2015','S',NULL,1,0,'2017-01-15'),(10,'C00-MA',0,1,2,750,NULL,'Cuota Mantenimiento','02','2015','A',NULL,NULL,2,'2017-01-15'),(11,'C00-MA',0,2,2,1500,NULL,'Cuota Mantenimiento','02','2015','A',NULL,NULL,2,'2017-01-15'),(12,'C00-MA',0,3,2,750,NULL,'Cuota Mantenimiento','02','2015','A',NULL,NULL,2,'2017-01-15'),(13,'C00-MA',0,4,2,1350,NULL,'Cuota Mantenimiento','02','2015','A',NULL,NULL,2,'2017-01-15'),(14,'C00-AG',0,1,3,973,973,'Cuota Agua','02','2015','S',NULL,NULL,0,'2017-01-15'),(15,'C00-AG',0,2,3,104.6,104.6,'Cuota Agua','02','2015','S',NULL,NULL,0,'2017-01-15'),(16,'C00-AG',0,3,3,130.75,0,'Cuota Agua','02','2015','A',NULL,NULL,0,'2017-01-15'),(17,'C00-AG',0,4,3,261.5,0,'Cuota Agua','02','2015','A',NULL,NULL,0,'2017-01-15'),(18,'C00-AG',0,5,3,78.45,0,'Cuota Agua','02','2015','A',NULL,NULL,0,'2017-01-15');
...
REPLACE INTO `kardex_servicios_detalle` VALUES ('01',1,1,3,1,80,418.40000000000003,'2015','1',5.23,'A','2017-01-15'),('01',2,2,3,1,100,523,'2015','1',5.23,'A','2017-01-15'),('01',3,3,3,1,100,523,'2015','1',5.23,'A','2017-01-15'),('01',4,3,3,1,75,1687.5,'2015','1A',22.5,'A','2017-01-15'),('01',5,4,3,1,100,523,'2015','1',5.23,'A','2017-01-15'),('01',6,4,3,1,75,1687.5,'2015','1A',22.5,'A','2017-01-15'),('01',7,4,3,1,25,977.5,'2015','2',39.1,'A','2017-01-15'),('01',8,5,3,1,100,523,'2015','1',5.23,'A','2017-01-15'),('01',9,5,3,1,20,450,'2015','1A',22.5,'A','2017-01-15'),('02',10,1,3,1,100,523,'2015','1',5.23,'A','2017-01-15'),('02',11,1,3,1,20,450,'2015','1A',22.5,'A','2017-01-15'),('02',12,2,3,1,20,104.60000000000001,'2015','1',5.23,'A','2017-01-15'),('02',13,3,3,1,25,130.75,'2015','1',5.23,'A','2017-01-15'),('02',14,4,3,1,50,261.5,'2015','1',5.23,'A','2017-01-15'),('02',15,5,3,1,15,78.45,'2015','1',5.23,'A','2017-01-15');
...
REPLACE INTO `pagos_anticipos` VALUES (1,1,'2','2017-01-15',750,'','0',0,'','0',0,NULL,'0',NULL,NULL,NULL),(2,2,'2','2017-01-15',1500,'','0',0,'','0',0,NULL,'0',NULL,NULL,NULL),(3,3,'2','2017-01-15',750,'','0',0,'','0',0,NULL,'0',NULL,NULL,NULL),(4,4,'2','2017-01-15',1350,'','0',0,'','0',0,NULL,'0',NULL,NULL,NULL),(5,3,'3','2017-01-15',2210.5,'','0',0,'','0',0,NULL,'0',NULL,NULL,NULL),(6,4,'3','2017-01-15',4161,'','0',0,'','0',0,NULL,'0',NULL,NULL,NULL);
...
REPLACE INTO `pagos_detalle` VALUES (1,1,750,'01','2015',1,NULL),(2,2,1500,'01','2015',1,NULL),(3,3,750,'01','2015',1,NULL),(4,4,1350,'01','2015',1,NULL),(5,5,2210.5,'01','2015',1,NULL),(6,6,3188,'01','2015',1,NULL),(7,6,973,'01','2015',1,NULL);
...
REPLACE INTO `saldo_anticipos` VALUES (4,1,608.5999999999999,'2017-01-15'),(5,2,372.4,'2017-01-15');
...
REPLACE INTO `tarifas_mantenimiento` VALUES (1,2,'Tarifa Variable','0.30','2015-01-01','A','2016-10-03'),(2,2,'Tarifa Variable','0.35','2016-01-01','P','2016-10-03'),(3,2,'Tarifa Variable','0.38','2017-01-01','P','2016-10-20');
...
CREATE TABLE `test` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5444 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
REPLACE INTO `test` VALUES (5440,'5 1000 - 418.40000000000003 - 1**0-2'),(5441,'5 1000 - 523 - 1**0-1'),(5442,'5 1000 - 973 - 0**0-2'),(5443,'5 1000 - 104.60000000000001 - 0**0-1');
       ...
       -- ----------------------------------------------------------------------------------------------
        ...
        -- ****************************************************************************************************************
         IF(numeroVencimientos <= 2 and numeroVencimientosMA<=2) THEN
           ...
           -- ** Validamos si excede el consumo en base a su CBA
            	IF(v_consumo<= v_CBA) THEN
					set importeCuota =v_consumo * v_tarifa1A;
					call gestion_granjas.sp_frm_PrcCuotas_AddDetalleServicio(v_medidor,'3','1',v_consumo,importeCuota,p_periodo,p_anio,'1A',v_tarifa1A);
				else
					-- Se obtiene importe de la tarifa1
...
-- Dump completed on 2017-01-15 20:30:43
