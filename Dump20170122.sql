...
INSERT INTO `kardex_servicios` VALUES (1,'C00-MA',0,1,2,750,NULL,'Cuota Mantenimiento','01','2015','V',NULL,NULL,2,NULL,NULL,'2017-01-21'),(2,'C00-MA',0,2,2,1500,NULL,'Cuota Mantenimiento','01','2015','V',NULL,NULL,2,NULL,NULL,'2017-01-21'),(3,'C00-MA',0,3,2,750,NULL,'Cuota Mantenimiento','01','2015','V',NULL,NULL,2,NULL,NULL,'2017-01-21'),(4,'C00-MA',0,4,2,1350,NULL,'Cuota Mantenimiento','01','2015','V',NULL,NULL,2,NULL,NULL,'2017-01-21'),(5,'C00-AG',0,1,3,418.4,0,'Cuota Agua','01','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(6,'C00-AG',0,2,3,523,0,'Cuota Agua','01','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(7,'C00-AG',0,3,3,2210.5,0,'Cuota Agua','01','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(8,'C00-AG',0,4,3,3188,0,'Cuota Agua','01','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(9,'C00-AG',0,5,3,973,0,'Cuota Agua','01','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(10,'C00-MA',0,1,2,750,NULL,'Cuota Mantenimiento','02','2015','V',NULL,NULL,2,NULL,NULL,'2017-01-21'),(11,'C00-MA',0,2,2,1500,NULL,'Cuota Mantenimiento','02','2015','V',NULL,NULL,2,NULL,NULL,'2017-01-21'),(12,'C00-MA',0,3,2,750,NULL,'Cuota Mantenimiento','02','2015','V',NULL,NULL,2,NULL,NULL,'2017-01-21'),(13,'C00-MA',0,4,2,1350,NULL,'Cuota Mantenimiento','02','2015','V',NULL,NULL,2,NULL,NULL,'2017-01-21'),(14,'C00-AG',0,1,3,973,0,'Cuota Agua','02','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(15,'C00-AG',0,2,3,104.6,0,'Cuota Agua','02','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(16,'C00-AG',0,3,3,130.75,0,'Cuota Agua','02','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(17,'C00-AG',0,4,3,261.5,0,'Cuota Agua','02','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(18,'C00-AG',0,5,3,78.45,0,'Cuota Agua','02','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(19,'C00-MA',0,1,2,750,NULL,'Cuota Mantenimiento','03','2015','V',NULL,NULL,2,NULL,NULL,'2017-01-21'),(20,'C00-MA',0,2,2,1500,NULL,'Cuota Mantenimiento','03','2015','V',NULL,NULL,2,NULL,NULL,'2017-01-21'),(21,'C00-MA',0,3,2,750,NULL,'Cuota Mantenimiento','03','2015','V',NULL,NULL,2,NULL,NULL,'2017-01-21'),(22,'C00-MA',0,4,2,1350,NULL,'Cuota Mantenimiento','03','2015','V',NULL,NULL,2,NULL,NULL,'2017-01-21'),(23,'C00-AG',0,1,3,313.8,0,'Cuota Agua','03','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(24,'C00-AG',0,2,3,423.63,0,'Cuota Agua','03','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(25,'C00-AG',0,3,3,1085.5,0,'Cuota Agua','03','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(26,'C00-AG',0,4,3,481.16,0,'Cuota Agua','03','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(27,'C00-AG',0,5,3,271.96,0,'Cuota Agua','03','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(28,'C00-MA',0,1,2,750,NULL,'Cuota Mantenimiento','04','2015','V',NULL,NULL,2,NULL,NULL,'2017-01-21'),(29,'C00-MA',0,2,2,1500,NULL,'Cuota Mantenimiento','04','2015','V',NULL,NULL,2,NULL,NULL,'2017-01-21'),(30,'C00-MA',0,3,2,750,NULL,'Cuota Mantenimiento','04','2015','V',NULL,NULL,2,NULL,NULL,'2017-01-21'),(31,'C00-MA',0,4,2,1350,NULL,'Cuota Mantenimiento','04','2015','V',NULL,NULL,2,NULL,NULL,'2017-01-21'),(32,'C00-AG',0,1,3,3127.5,0,'Cuota Agua','04','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(33,'C00-AG',0,2,3,2250,0,'Cuota Agua','04','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(34,'C00-AG',0,3,3,2250,0,'Cuota Agua','04','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(35,'C00-AG',0,4,3,2250,0,'Cuota Agua','04','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(36,'C00-AG',0,5,3,4915,0,'Cuota Agua','04','2015','V',NULL,NULL,0,NULL,NULL,'2017-01-21'),(37,'C00-MA',0,1,2,750,NULL,'Cuota Mantenimiento','05','2015','A',NULL,NULL,2,NULL,NULL,'2017-01-21'),(38,'C00-MA',0,2,2,1500,NULL,'Cuota Mantenimiento','05','2015','A',NULL,NULL,2,NULL,NULL,'2017-01-21'),(39,'C00-MA',0,3,2,750,NULL,'Cuota Mantenimiento','05','2015','A',NULL,NULL,2,NULL,NULL,'2017-01-21'),(40,'C00-MA',0,4,2,1350,NULL,'Cuota Mantenimiento','05','2015','A',NULL,NULL,2,NULL,NULL,'2017-01-21'),(41,'C00-AG',0,1,3,2250,0,'Cuota Agua','05','2015','A',NULL,NULL,0,NULL,NULL,'2017-01-21'),(42,'C00-AG',0,2,3,2250,0,'Cuota Agua','05','2015','A',NULL,NULL,0,NULL,NULL,'2017-01-21'),(43,'C00-AG',0,3,3,2250,0,'Cuota Agua','05','2015','A',NULL,NULL,0,NULL,NULL,'2017-01-21'),(44,'C00-AG',0,4,3,2250,0,'Cuota Agua','05','2015','A',NULL,NULL,0,NULL,NULL,'2017-01-21'),(45,'C00-AG',0,5,3,2250,0,'Cuota Agua','05','2015','A',NULL,NULL,0,NULL,NULL,'2017-01-21');
...
if(p_servicio=2) then
	SELECT a.id,a.id_servicio,importe +IFNULL(moratorio,0) ,concat(a.periodo,'/',date_format(concat(anio, a.periodo,'01'), '%y') ,
		' (', date_format(concat(anio, a.periodo,'01'), '%b %Y'),' ) $ ', (importe + IFNULL(moratorio,0)) ), b.Descripcion,
		c.servicio,date_format(concat(anio, a.periodo,'01'), '%M %Y') as Concat_periodo, a.periodo,
		concat( d.descripcion,' (',d.valor,')') as tasa_periodo,a.anio,IFNULL(moratorio,0)
...
SELECT e.id_lote,a.id_servicio,truncate(sum(importe)+SUM(IFNULL(moratorio,0))-SUM(IFNULL(saldo_pagado,0)),2) ,concat(a.periodo,'/',date_format(concat(anio, a.periodo,'01'), '%y') ,
		' (', date_format(concat(anio, a.periodo,'01'), '%b %Y'),' ) $ '), b.Descripcion,
		c.servicio,date_format(concat(anio, a.periodo,'01'), '%M %Y') as Concat_periodo, a.periodo, 
CONCAT('Tarifa ',a.tarifa) as tasa_periodo,a.anio,SUM(IFNULL(moratorio,0))
	FROM gestion_granjas.kardex_servicios a
   ...
   if(p_servicio=4) then 
	  SELECT a.id,4,a.cuota+ IFNULL(moratorio,0),
		concat(date_format(fecha_convenio, '%d/%m/%y') ,
				...
				'Tarifa 2' as tasa_periodo,
				 date_format(fecha_convenio, '%Y') as anio, IFNULL(moratorio,0)
...
BEGIN
  ...
  DECLARE done INT DEFAULT FALSE;
	  ...
	  -- ********************************************************
	  -- Se ejecuta proceso de traspaso de cuotas (Vigentes - Vencidas * anexando el saldo moratorio de la cuota)
	  -- ********************************************************
       
		UPDATE  gestion_granjas.convenios_detalle SET moratorio= (3/100)* ( cuota) , fecha_moratorio=now(),estatus='V' 
		where  date_format(fecha_convenio, '%m')=p_periodo and  date_format(fecha_convenio, '%Y')=p_anio and estatus='A';
...
-- Dump completed on 2017-01-22 19:19:12
