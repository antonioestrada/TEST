...
namespace WFPGranjas.Backend.Catalogos
{
    class CPuestos
    {
        public ResultadoTrnx altaBPuestos(Object[] parames)
        {
            System.Data.IDataReader resul = Conexion.GDatos.TraerDataReader("gestion_granjas.sp_catalogo_ABCPuesto", parames);
        ...
        public void consultaPuestos(DataGridView dgConsulta, int op)
        {
